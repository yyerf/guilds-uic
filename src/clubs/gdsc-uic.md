...
officers:
  ...
  - name: Geoffrey J. Diapana
    position: Chief Executive Officer
    photo_name: Enrique_Lead.jpg

  - name: Troy Wendell Peralta
    position: Chief Operating Officer
    photo_name: Peralta_COO.jpg

  - name: Francis Franklin Bangoy
    position: Chief Technology Officer
    photo_name: Bangoy_CTO.jpg
  ...
  - name: Earl Cedric Coronado
    ...
    photo_name: Coronado_CMO.jpg

  - name: Lemeul Abellana
    position: Chief Community Development Officer
    photo_name: Abellana_CCDO.jpg

  - name: Weszly Keith Empasis
    position: Secretary
    photo_name: Empasis_Secretary.jpg

  - name: Dwyn Richie Lasala
    position: Events Lead
    photo_name: Lasala_EventsLead.jpg

  - name: Cyrus Gabriel Macrohon
    position: Graphics Designer
    photo_name: Macrohon_GraphicsDesigner.jpg

  - name: Dana Faye Colango
    position: Social Media Manager
    photo_name: Colango_SocialMediaManager.jpg

  - name: James Khee
    position: Documentation Lead
    photo_name: Khee_DocuLead.jpg

  - name: Christian Jay Galorio
    position: Core Member
    photo_name: Galorio_Core.jpg

  - name: Angelo Josef U. Gatan
    position: Core Member
    photo_name: Gatan_Core.jpg

  - name: Matthew Ikee
    position: Core Member
    photo_name: Ikee_Core.jpg

  - name: Vinze Jerhald Lulab
    position: Core Member
    photo_name: Lulab_Core.jpg

  - name: Drazen Nepa Jr.
    position: Core Member
    photo_name: Nepa_Core.jpg

  - name: Renz Pastrana
    position: Core Member
    photo_name: Pastrana_Core.jpg

  - name: Jim Nick F. Quezada
    position: Core Member
