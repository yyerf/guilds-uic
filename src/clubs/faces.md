...
officers:
  ...
  - name: Claire Joy L. Montebon
    position: Vice Mayor (Internal)
    photo_name: VICE-MAYOR.jpg
  - name: Julianne Liv Gonzalgo
    position: Vice Mayor (External)
    photo_name: VICE-MAYOR.jpg
  - name: Kimberly T. Bendoy
    position: Secretary
    photo_name: SECRETARY.jpg
  - name: Jervie Jane L. Arman
    position: Assistant Secretary
    photo_name: SECRETARY.jpg
  - name: Jazzly Jeanne E. Dollecin
    position: Treasurer
    photo_name: TREASURER.jpg
  - name: Joshua M. Visto
    position: Auditor
    photo_name: AUDITOR.png
  - name: Jorge Gabriel D. Leysa
    position: PIO (Main)
    photo_name: PIO.jpg
  - name: Chino Dominic U. Mendez
    position: PIO (Annex)
    photo_name: PIO.jpg
  - name: Kurt Laurence Necholii G. Artillo
    position: Creative Team Head Committee
    photo_name: PIO.jpg
  - name: Julianne Camyl Balanon
    position: Creative Team Head Committee
    photo_name: PIO.jpg
